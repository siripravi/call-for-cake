...
if ( current_user_can('administrator') ) {
        ...
        $hightlight_text = ( get_comment_meta( get_comment_ID(), 'rt_highlight', true ) == 1 ) ? esc_html__( 'Remove Highlight?', 'review-schema-pro' ) : esc_html__( 'Highlight?', 'review-schema-pro' ); 
    ?>
