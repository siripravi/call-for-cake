				...
				<div class="item-content">
					...
					switch ( $product->get_type() ) {
						...
						?>
							...
							<?php $prices = array( $product->get_variation_price( 'min', true ), $product->get_variation_price( 'max', true ) ); echo wp_kses( $currency . number_format(($prices[0] + $prices[1])/2 , 2 ) , 'alltext_allow' ); ?>
							</div>						
						<?php break;
							case "grouped" :
