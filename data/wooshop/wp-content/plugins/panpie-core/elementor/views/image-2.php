...
<div class="image-default image-<?php echo esc_attr( $data['style'] );?>">
	<div class="rtin-image">
		...
		<div class="animate-left wow fadeInDown" data-wow-delay="700ms" data-wow-duration="1200ms">
			<?php echo wp_kses_post($getimg2);?>
		</div>
		<div class="animate-right wow fadeInDown" data-wow-delay="900ms" data-wow-duration="1500ms">
