...
?>
<div class="shop-layout-<?php echo esc_attr( $data['style'] );?>">
		...
		<?php if ( $query->have_posts() ) { ?>
			<?php while ( $query->have_posts() ) {
                ...
                if ($product->get_type() == 'variable') {
                    ...
                    $itemAttributes = !empty($attributes['pa_' . $selected_attribute]) && is_array($attributes['pa_' . $selected_attribute]) ? $attributes['pa_' . $data['variation_cat']] : [];
                    if (!empty($variations)) {
			...
			?>
		<div class="col">
			<div class="food-box-5" data-product_id="<?php echo absint($product_id); ?>" data-product_variations="<?php echo htmlspecialchars(wp_json_encode($variations)); ?>">
				<div class="item-img">
