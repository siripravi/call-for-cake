...
## Scripts
*************************************************/
function shopwise_products_navigation_scripts() {
	wp_enqueue_style( 'klb-products-navigation',   plugins_url( 'css/single-products-navigation.css', __FILE__ ), false, '1.0');

}
add_action( 'wp_enqueue_scripts', 'shopwise_products_navigation_scripts' );

/*************************************************
## Single Product Nav
*************************************************/ 

if ( ! function_exists( 'shopwise_product_nav' ) ) {
	function shopwise_product_nav() {
						...
						<div class="product-short">
							<div class="product-short-image">
								<a href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" class="product-thumb">
									<?php echo apply_filters( 'shopwise_products_nav_image', get_the_post_thumbnail( $prev_post ) ); ?>
								</a>
							</div>
						...
						<div class="product-short">
							<div class="product-short-image">
								<a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" class="product-thumb">
									<?php echo apply_filters( 'shopwise_products_nav_image', get_the_post_thumbnail( $next_post ) ); ?>
								</a>
							</div>
							<div class="product-short-description">
...
add_action( 'woocommerce_single_product_summary', 'shopwise_product_nav', 2 );