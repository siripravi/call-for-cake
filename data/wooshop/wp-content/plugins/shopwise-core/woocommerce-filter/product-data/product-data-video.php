...
## Scripts
*************************************************/
function shopwise_product_data_video_scripts() {
...
add_action( 'wp_enqueue_scripts', 'shopwise_product_data_video_scripts' );
...
add_action('woocommerce_product_data_panels', function() {
	...
	woocommerce_wp_textarea_input([
		...
		'label' => esc_html__('Video URL', 'shopwise-core'),
		'wrapper_class' => 'show_if_simple show_if_variable show_if_grouped',
		'desc_tip'    => true,
		'description' => esc_html__( 'Enter a youtube or a vimeo video url for the single product.', 'shopwise-core' ),
	]);
...
function klb_product_data_video(){
	...
	if($videourl){
		...
		echo '<div class="klb-single-video"><a class="'.esc_attr($videoclass).'" href="'.esc_url($videourl).'"><span>'.esc_html__('Watch video','shopwise-core').'</span></a></div>';
