<?php
if(get_theme_mod('shopwise_single_image_zoom') == 1 || shopwise_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function shopwise_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'shopwise_image_zoom_scripts' );
...
function shopwise_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'shopwise_image_zoom_setup' );
