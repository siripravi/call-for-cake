...
class widget_single_banner3 extends WP_Widget { 
	
	// Widget Settings
	function __construct() {
		$widget_ops = array('description' => esc_html__('Single Banner 3.','shopwise') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'single_banner3' );
		 parent::__construct( 'single_banner3', esc_html__('Shopwise Single Banner 3','shopwise'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		<div class="klb-banner-3 header_banner">
			<div class="header_banner_content">
				<div class="shop_banner">
					<?php if(isset($instance['imageid'])){ ?>
					<div class="banner_img overlay_bg_40">
						<img src="<?php echo esc_url(wp_get_attachment_url($instance['imageid'])); ?>" alt="shop_banner"/>
					</div>
					<?php } ?>
...
// Add Widget
function widget_single_banner3_init() {
	register_widget('widget_single_banner3');
}
add_action('widgets_init', 'widget_single_banner3_init');
?>