<?php
/**
 * Template: Grid by Category Free (2).
 *
 * @package RT_FoodMenu
 */
...
$html  = '<div class="fmp-category-background">';
...
while ( $gridQuery->have_posts() ) {
	...
	if ( $source == 'product' && $wc == true ) {
		...
		$priceClass  = 'variable' === $pType ? ' is-variable wc' : '';
	...
	$html .= '</div>';
	$html .= '<div class="fmp-footer' . $wooClass . $priceClass . '">';
