...
<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
    ...
    <nav data-bs-theme="<?php echo get_theme_mod('picostrap_header_navbar_color_scheme_attr', 'dark') ?>" class="navbar navbar-expand-md bg-body-tertiary <?php echo get_theme_mod('picostrap_header_navbar_expand', 'navbar-expand-lg'); ?> <?php echo get_theme_mod('picostrap_header_navbar_position') . " " . get_theme_mod('picostrap_header_navbar_color_choice', 'bg-dark'); ?>" aria-label="Main Navigation">
            ...
            <div id="logo-tagline-wrap">
                ...
                <?php if (!has_custom_logo()) { ?>
                    ...
                    <?php if (is_front_page() && is_home()) : ?>
                        ...
                        <div class="navbar-brand mb-0 h3"><a rel="home" href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" itemprop="url">
                                <?php bloginfo('name'); ?>
                            </a></div>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <?php if (get_theme_mod('enable_search_form')) : ?>
                    <div class="search-and-icons">
                        <form action="<?php echo bloginfo('url') ?>" method="get" id="header-search-form" class="d-flex mb-2 me-2">
                            <input class="form-control me-2" type="text" placeholder="<?php _e("Search", 'picostrap5') ?>" aria-label="<?php _e("Search", 'picostrap5') ?>" name="s" value="<?php the_search_query(); ?>">
                        </form>
