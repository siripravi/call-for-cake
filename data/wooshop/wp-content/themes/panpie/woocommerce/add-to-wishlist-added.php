...
global $product;
$browse_wishlist_text = strpos( $browse_wishlist_text, '</i>') == false ? $browse_wishlist_text : '<i class="fas fa-heart"></i>';
?>

<!-- ADDED TO WISHLIST MESSAGE -->
<div class="yith-wcwl-wishlistaddedbrowse">
	<span class="feedback">
        <?php echo wp_kses( $icon ); ?>
        <?php echo wp_kses( $product_added_text ); ?>
    </span>
