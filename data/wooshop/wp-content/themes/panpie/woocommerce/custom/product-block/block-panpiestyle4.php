...
$excerpt = wp_trim_words( get_the_excerpt(), PanpieTheme::$options['wc_show_excerpt_limit'], '' );
...
?>
<div class="col shop-layout-4 <?php echo esc_html( $terms_of_item ); ?>">
	<div class="food-box variation-number-<?php echo esc_attr($attribute_limit); ?>" data-product_id="<?php echo absint($product_id); ?>"
		...
		<div class="item-content">
			...
			<?php if ( PanpieTheme::$options['wc_show_excerpt'] ) { ?><p><?php echo wp_kses( $excerpt , 'alltext_allow' ); ?></p><?php } ?>
