				...
				<div class="header-icon-area">
					...
					<?php if ( PanpieTheme::$options['online_button'] == '1' ) { ?>
						<div class="header-button">
							<a class="btn-fill-dark" target="_self" href="<?php echo esc_url( PanpieTheme::$options['online_button_link']  );?>"><?php echo esc_html( PanpieTheme::$options['online_button_text'] );?></a>
						</div>
					<?php } ?>
				</div>
				<?php } ?>
