...
if( ! function_exists( 'panpie_breadcrumbs' )){

	function panpie_breadcrumbs(){
			
		if( PanpieTheme::$options['breadcrumb_active'] == 0 ) {			
			return;
		}
		...
		$home_text  = esc_html__( 'Home', 'panpie' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){			
				...
				if ( get_post_type() == 'post' ){
					...
					$category = panpie_get_primary_category_id();
					$category = get_category( $category );
