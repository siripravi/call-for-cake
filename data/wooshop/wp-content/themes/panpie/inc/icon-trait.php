...
trait IconTrait {
  ...
  public static function get_flaticon_icons()
  {
	...
	"flaticon-minute" => "minute",
	"flaticon-arrival" => "arrival",
	"flaticon-user" => "user",
	"flaticon-money" => "money",
	"flaticon-growth" => "growth",
	"flaticon-approved" => "approved",
	"flaticon-mortgage" => "mortgage",
	"flaticon-car-event" => "car-event",
	"flaticon-health-event" => "health-event",
	"flaticon-event" => "event",
	"flaticon-wedding-rings" => "wedding-rings",
	"flaticon-handshake" => "handshake",
	"flaticon-suitcases" => "suitcases",
	"flaticon-fire" => "fire",
	"flaticon-hacker" => "hacker",
