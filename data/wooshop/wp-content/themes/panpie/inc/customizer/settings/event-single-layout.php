 ...
 */
class PanpieTheme_Event_Single_Layout_Settings extends PanpieTheme_Customizer {
    ...
    public function register_event_single_layout_controls( $wp_customize ) {
        ...
        $wp_customize->add_setting( 'event_layout',
            array(
                'default' => $this->defaults['event_layout'],
                'transport' => 'refresh',
                'sanitize_callback' => 'rttheme_radio_sanitization'
            )
        );
        $wp_customize->add_control( new Customizer_Image_Radio_Control( $wp_customize, 'event_layout',
            array(
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new PanpieTheme_Event_Single_Layout_Settings();
}
