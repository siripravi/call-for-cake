...
?>
<div id="primary" class="content-area shop-page <?php if ( BootscoreChild::$options['wc_archive_layouts'] !== 'regular' ) { ?>food-menu-inner<?php } ?>">
	<div class="container">
		<div class="row">
			<?php if ( BootscoreChild::$layout == 'left-sidebar' ) { ?>
			...
			<div class="<?php echo esc_attr( $panpie_layout_class );?>">				
				<?php
					if ( BootscoreChild::$options['wc_block_layouts'] == 'regular' ){ 
						$product_box_class = 'regular';
					} else if( BootscoreChild::$options['wc_block_layouts'] == 'panpiestyle' ){
						$product_box_class = 'isotope-wrap';
					} else if( BootscoreChild::$options['wc_block_layouts'] == 'panpiestyle2' ){
						$product_box_class = 'isotope-wrap food-menu-combo menu-combo-inner';
					} else if( BootscoreChild::$options['wc_block_layouts'] == 'panpiestyle3' ){
						$product_box_class = 'food-menu-isotop isotope-wrap';
					} else if( BootscoreChild::$options['wc_block_layouts'] == 'panpiestyle4' ){
						$product_box_class = 'isotope-wrap';
					}
				?>
