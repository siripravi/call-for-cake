...
global $product;
$shop_product_sidebar_get = filter_input( INPUT_GET, 'shop_product_sidebar', FILTER_SANITIZE_STRING );

$shop_product_sidebar          = isset( $shop_product_sidebar_get ) ? $shop_product_sidebar_get : ot_get_option( 'shop_product_sidebar', 'off' );
...
$classes[] = 'thb-product-style1';
$classes[] = 'thb-product-thumbnail-' . $shop_product_thumbnail_layout;
?>
