...
class RT_Team extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Team', 'panpie-core' );
	...
	public function rt_fields(){
		$terms = get_terms( array( 'taxonomy' => 'panpie_team_category', 'fields' => 'id=>name' ) );
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Team Grid 1', 'panpie-core' ),
					'style2' => esc_html__( 'Team Grid 2', 'panpie-core' ),
					'style5' => esc_html__( 'Team Grid 3', 'panpie-core' ),
					'style6' => esc_html__( 'Team Grid 4', 'panpie-core' ),
					'style3' => esc_html__( 'Team Slider 1', 'panpie-core' ),
					'style4' => esc_html__( 'Team Slider 2', 'panpie-core' ),
				),
				'default' => 'style1',
			),
			array(
			...
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'item_space',
				'label'   => esc_html__( 'Item Space', 'panpie-core' ),
				'options' => array(
					'no-gutters' => esc_html__( 'Item No Gap', 'panpie-core' ),
					'item-gap' => esc_html__( 'Item Gap', 'panpie-core' ),
				),
				'default' => 'no-gutters',
			...
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'contype',
				'label'   => esc_html__( 'Content Type', 'panpie-core' ),
				'options' => array(
					'content' => esc_html__( 'Conents', 'panpie-core' ),
					'excerpt' => esc_html__( 'Excerpts', 'panpie-core' ),
				),
				'default'     => 'content',
				'description' => esc_html__( 'Display contents from Editor or Excerpt field', 'panpie-core' ),
			),
			array(
				'type'    => Controls_Manager::NUMBER,
				'id'      => 'count',
			...
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'social_display',
				'label'       => esc_html__( 'Social Media Display', 'panpie-core' ),
				'label_on'    => esc_html__( 'On', 'panpie-core' ),
				'label_off'   => esc_html__( 'Off', 'panpie-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Social Medias. Default: On', 'panpie-core' ),
			),
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'more_button',
			...
			array (
				...
				'default' => esc_html__( 'MORE TEAMS', 'panpie-core' ),
				'condition'   => array( 'more_button' => array( 'show' ), 'style' => array( 'style1', 'style2', 'style5', 'style6' ) ),
			),
			array (
				'type'    => Controls_Manager::TEXT,
				'id'      => 'see_button_link',
