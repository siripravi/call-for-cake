...
class RT_Gallery extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Gallery', 'panpie-core' );
	...
	public function rt_fields(){
		...
		$terms  = get_terms( array( 'taxonomy' => 'panpie_gallery_category', 'fields' => 'id=>name' ) );
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'layout1' => esc_html__( 'Grid layout 1', 'panpie-core' ),
					'layout2' => esc_html__( 'Grid layout 2', 'panpie-core' ),
					'layout3' => esc_html__( 'Grid layout 3', 'panpie-core' ),
				),
				'default' => 'layout1',
			),
			array (
			...
			array (
				...
				'id'          => 'cat_display',
				'label'       => esc_html__( 'Category Name Display', 'panpie-core' ),
			...
			array(
				...
				'default' => 15,
				'description' => esc_html__( 'Maximum number of words', 'panpie-core' ),
				'condition'   => array( 'excerpt_display' =>'yes', 'layout' => array( 'layout1', 'layout2' ) ),
			),
			array (
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'view_display',
				'label'       => esc_html__( 'PopUp Display', 'panpie-core' ),
				'label_on'    => esc_html__( 'Show', 'panpie-core' ),
				'label_off'   => esc_html__( 'Hide', 'panpie-core' ),
				'default'     => 'yes',
			),
			array (
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'link_display',
				'label'       => esc_html__( 'Link Display', 'panpie-core' ),
				'label_on'    => esc_html__( 'Show', 'panpie-core' ),
				'label_off'   => esc_html__( 'Hide', 'panpie-core' ),
				'default'     => 'yes',
				'condition'   => array( 'layout' => array( 'layout1', 'layout2' ) ),
			...
			array (
				...
				'selector' => '{{WRAPPER}} .portfolio-default .rtin-content h3',
			),
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'more_button',
			...
			array (
				...
				'default' => esc_html__( 'ALL PORTFOLIO', 'panpie-core' ),
