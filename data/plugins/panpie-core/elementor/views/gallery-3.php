...
?>
<div class="gallery-default gallery-multi-layout-3 gallery-<?php echo esc_attr( $data['layout'] );?>">
		...
		<div class="<?php if ( ( $i == $posts_per_page ) && ( $posts_per_page % 2 == 1 ) ) { echo esc_attr( $is_offset ) ; } echo esc_attr( $col_class ) ?>">
			<div class="rtin-item">
				...
				<div class="rtin-content">
					...
					<div class="item-icon">
						<a href="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" class="img-popup-icon" data-elementor-open-lightbox="yes" data-elementor-lightbox-slideshow="1" data-elementor-lightbox-title="<?php echo get_the_title(); ?>"><i class="fas fa-arrows-alt"></i></a>	
					</div>
					<?php } ?>
