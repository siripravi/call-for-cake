...
class PanpieTheme_Address_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            'panpie_address', // Base ID
            esc_html__( 'Panpie : Address (for footer)', 'panpie-core' ), // Name
            array( 'description' => esc_html__( 'Address Widget', 'panpie-core' ) ) // Args
            );
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'   		=> esc_html__( 'Corporate Office' , 'panpie-core' ),
			'description'	=> '',
			'address'		=> '',
			'phone'   		=> '',
			'email'   		=> '',
