...
/**
* About Widget with Social for footer by PanpieTheme
**/
class PanpieTheme_Social_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'rt_footer_social_widget',
			'description' => esc_html__( 'Panpie : (For Footer) Social Link widget with Description' , 'panpie-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-about-social', esc_html__( 'Panpie : Social Widget' , 'panpie-core' ), $widget_ops );
		$this->alt_option_name = 'panpie_about_widget';
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'       => esc_html__( 'About Company' , 'panpie-core' ),
			'description' => '',
			'facebook'    => '',
			'twitter'     => '',
			'gplus'       => '',
		...
		$fields = array(
			...
			'pinterest'    => array(
				'label'    => esc_html__( 'Pinterest URL', 'panpie-core' ),
				'type'     => 'url',
				),
			'skype'        => array(
				'label'    => esc_html__( 'Skype URL', 'panpie-core' ),
				'type'     => 'url',
				),
			'youtube'      => array(
			...
			'behance'      => array(
				'label'    => esc_html__( 'Behance Plus URL', 'panpie-core' ),
				'type'     => 'url',
				),
			'dribbble'     => array(
				'label'    => esc_html__( 'Dribbble Plus URL', 'panpie-core' ),
				'type'     => 'url',
				),
			);
