					...
					array(
						...
						'pages' => array(
							array(
								...
								'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'peakshops' ) ),
								'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'peakshops' ) ),
								...
								'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'peakshops' ) ),
								'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'peakshops' ) ),
								'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'peakshops' ) ),
	...
	function ot_register_settings_page() {
		...
		if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
			...
			function ot_has_custom_theme_options() {
				...
				echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'peakshops' ) . '</p></div>';
		...
		$ot_register_pages_array = array(
			array(
				'id'          => 'ot',
				'page_title'  => __( 'OptionTree', 'peakshops' ),
				'menu_title'  => __( 'OptionTree', 'peakshops' ),
			...
			array(
				...
				'page_title'      => __( 'Settings', 'peakshops' ),
				'menu_title'      => __( 'Settings', 'peakshops' ),
				'capability'      => 'edit_theme_options',
				'menu_slug'       => 'ot-settings',
				'icon_url'        => null,
				'position'        => null,
				'updated_message' => __( 'Theme Options updated.', 'peakshops' ),
				'reset_message'   => __( 'Theme Options reset.', 'peakshops' ),
				'button_text'     => __( 'Save Settings', 'peakshops' ),
				'show_buttons'    => false,
				'sections'        => array(
					array(
						'id'    => 'create_setting',
						'title' => __( 'Theme Options UI', 'peakshops' ),
					),
					array(
						'id'    => 'import',
						'title' => __( 'Import', 'peakshops' ),
					),
					array(
						'id'    => 'export',
						'title' => __( 'Export', 'peakshops' ),
					),
					array(
						'id'    => 'layouts',
						'title' => __( 'Layouts', 'peakshops' ),
					),
				),
				'settings'        => array(
					array(
						'id'      => 'theme_options_ui_text',
						'label'   => __( 'Theme Options UI Builder', 'peakshops' ),
						'type'    => 'theme_options_ui',
						'section' => 'create_setting',
					),
					array(
						'id'      => 'import_xml_text',
						'label'   => __( 'Settings XML', 'peakshops' ),
						'type'    => 'import-xml',
						'section' => 'import',
					),
					array(
						'id'      => 'import_settings_text',
						'label'   => __( 'Settings', 'peakshops' ),
						'type'    => 'import-settings',
						'section' => 'import',
					),
					array(
						'id'      => 'import_data_text',
						'label'   => __( 'Theme Options', 'peakshops' ),
						'type'    => 'import-data',
						'section' => 'import',
					),
					// array(
					// 'id'          => 'import_layouts_text',
					// 'label'       => __( 'Layouts', 'peakshops' ),
					// 'type'        => 'import-layouts',
					// 'section'     => 'import'
					// ),
					// array(
					// 'id'          => 'export_settings_file_text',
					// 'label'       => __( 'Settings PHP File', 'peakshops' ),
				...
				// 'label'       => __( 'Layout Management', 'peakshops' ),
				// 'type'        => 'modify-layouts',
				// 'section'     => 'layouts'
				// )
				),
			...
			array(
				'id'              => 'documentation',
				'parent_slug'     => 'ot-settings',
				'page_title'      => __( 'Documentation', 'peakshops' ),
				'menu_title'      => __( 'Documentation', 'peakshops' ),
				'capability'      => 'edit_theme_options',
				...
				'sections'        => array(
					array(
						'id'    => 'creating_options',
						'title' => __( 'Creating Options', 'peakshops' ),
					),
					array(
						'id'    => 'option_types',
						'title' => __( 'Option Types', 'peakshops' ),
					),
					array(
						'id'    => 'functions',
						'title' => __( 'Function References', 'peakshops' ),
					),
					array(
						'id'    => 'theme_mode',
						'title' => __( 'Theme Mode', 'peakshops' ),
					),
					array(
						'id'    => 'meta_boxes',
						'title' => __( 'Meta Boxes', 'peakshops' ),
					),
					array(
						'id'    => 'examples',
						'title' => __( 'Code Examples', 'peakshops' ),
					),
					array(
						'id'    => 'layouts_overview',
						'title' => __( 'Layouts Overview', 'peakshops' ),
					),
				),
				'settings'        => array(
					array(
						'id'      => 'creating_options_text',
						'label'   => __( 'Overview of available Theme Option fields.', 'peakshops' ),
						'type'    => 'creating-options',
						'section' => 'creating_options',
					),
					array(
						'id'      => 'option_types_text',
						'label'   => __( 'Option types in alphabetical order & hooks to filter them.', 'peakshops' ),
						'type'    => 'option-types',
						'section' => 'option_types',
					),
					array(
						'id'      => 'functions_ot_get_option',
						'label'   => __( 'Function Reference:ot_get_option()', 'peakshops' ),
						'type'    => 'ot-get-option',
						'section' => 'functions',
					),
					array(
						'id'      => 'functions_get_option_tree',
						'label'   => __( 'Function Reference:get_option_tree()', 'peakshops' ),
						'type'    => 'get-option-tree',
						'section' => 'functions',
					),
					array(
						'id'      => 'theme_mode_text',
						'label'   => __( 'Theme Mode', 'peakshops' ),
						'type'    => 'theme-mode',
						'section' => 'theme_mode',
					),
					array(
						'id'      => 'meta_boxes_text',
						'label'   => __( 'Meta Boxes', 'peakshops' ),
						'type'    => 'meta-boxes',
						'section' => 'meta_boxes',
					),
					array(
						'id'      => 'example_text',
						'label'   => __( 'Code examples for front-end development.', 'peakshops' ),
						'type'    => 'examples',
						'section' => 'examples',
					),
					array(
						'id'      => 'layouts_overview_text',
						'label'   => __( 'What\'s a layout anyhow?', 'peakshops' ),
...
if ( ! function_exists( 'ot_validate_setting' ) ) {
	...
	function ot_validate_setting( $input, $type, $field_id, $wmpl_id = '' ) {
		...
		if ( 'background' == $type ) {
			...
			foreach ( $input as $key => $value ) {
				...
				if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
					...
					add_settings_error( 'option-tree', 'invalid_border_width', sprintf( __( 'The %1$s input field for %2$s only allows numeric values.', 'peakshops' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
			...
			if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
				...
				add_settings_error( 'option-tree', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'peakshops' ), '<code>' . $field_id . '</code>' ), 'error' );
		...
		} elseif ( in_array( $type, array( 'css', 'javascript', 'text', 'textarea', 'textarea-simple' ) ) ) {
			...
			if ( isset( $errors ) ) {
				...
				foreach ( $errors as $error ) {
					...
					add_settings_error( 'option-tree', 'invalid_dimension_' . $error, sprintf( __( 'The %1$s input field for %2$s only allows numeric values.', 'peakshops' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
			...
			if ( isset( $errors ) ) {
				...
				foreach ( $errors as $error ) {
					...
					add_settings_error( 'option-tree', 'invalid_spacing_' . $error, sprintf( __( 'The %1$s input field for %2$s only allows numeric values.', 'peakshops' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
	...
	function ot_admin_scripts() {
		...
		$localized_array = array(
			...
			'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'peakshops' ) ),
			'remove_media_text'     => __( 'Remove Media', 'peakshops' ),
			'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'peakshops' ),
			'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'peakshops' ),
			'remove_agree'          => __( 'Are you sure you want to remove this?', 'peakshops' ),
			'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'peakshops' ),
			'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'peakshops' ),
			'delete'                => __( 'Delete Gallery', 'peakshops' ),
			'edit'                  => __( 'Edit Gallery', 'peakshops' ),
			'create'                => __( 'Create Gallery', 'peakshops' ),
			'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'peakshops' ),
			'date_current'          => __( 'Today', 'peakshops' ),
			'date_time_current'     => __( 'Now', 'peakshops' ),
			'date_close'            => __( 'Close', 'peakshops' ),
			'replace'               => __( 'Featured Image', 'peakshops' ),
			'with'                  => __( 'Image', 'peakshops' ),
		);
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
	...
	function ot_create_media_post() {
		...
		$regsiter_post_type(
			'option-tree',
			array(
				'labels'              => array( 'name' => __( 'Option Tree', 'peakshops' ) ),
				'public'              => false,
				'show_ui'             => false,
			...
			if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
				...
				$settings = array(
					'sections' => array(
						array(
							'id'    => 'general',
							'title' => __( 'General', 'peakshops' ),
						),
					),
					'settings' => array(
						array(
							'id'        => 'sample_text',
							'label'     => __( 'Sample Text Field Label', 'peakshops' ),
							'desc'      => __( 'Description for the sample text field.', 'peakshops' ),
							'section'   => 'general',
							'type'      => 'text',
							'std'       => '',
							'class'     => '',
	...
	function ot_alert_message( $page = array() ) {
		...
		if ( $action == 'save-settings' ) {
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'peakshops' ) . '</p></div>';

			} elseif ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'peakshops' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'peakshops' ) . '</p></div>';

			} elseif ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'peakshops' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'peakshops' ) . '</p></div>';

			} elseif ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'peakshops' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'peakshops' ) . '</p></div>';

			} elseif ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'peakshops' ) . '</p></div>';
			...
			if ( $message == 'success' ) {
				...
				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'peakshops' ) . '</p></div>';

			} elseif ( $message == 'failed' ) {

				return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'peakshops' ) . '</p></div>';

			} elseif ( $message == 'deleted' ) {

				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'peakshops' ) . '</p></div>';

			}
		} elseif ( $updated == 'layout' ) {

				return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'peakshops' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
	...
	function ot_option_types_array() {
		...
		return apply_filters(
			...
			array(
				'background'                => __( 'Background', 'peakshops' ),
				'border'                    => __( 'Border', 'peakshops' ),
				'box-shadow'                => __( 'Box Shadow', 'peakshops' ),
				'category-checkbox'         => __( 'Category Checkbox', 'peakshops' ),
				'category-select'           => __( 'Category Select', 'peakshops' ),
				'checkbox'                  => __( 'Checkbox', 'peakshops' ),
				'colorpicker'               => __( 'Colorpicker', 'peakshops' ),
				'colorpicker-opacity'       => __( 'Colorpicker Opacity', 'peakshops' ),
				'css'                       => __( 'CSS', 'peakshops' ),
				'custom-post-type-checkbox' => __( 'Custom Post Type Checkbox', 'peakshops' ),
				'custom-post-type-select'   => __( 'Custom Post Type Select', 'peakshops' ),
				'date-picker'               => __( 'Date Picker', 'peakshops' ),
				'date-time-picker'          => __( 'Date Time Picker', 'peakshops' ),
				'dimension'                 => __( 'Dimension', 'peakshops' ),
				'gallery'                   => __( 'Gallery', 'peakshops' ),
				'google-fonts'              => __( 'Google Fonts', 'peakshops' ),
				'javascript'                => __( 'JavaScript', 'peakshops' ),
				'link-color'                => __( 'Link Color', 'peakshops' ),
				'list-item'                 => __( 'List Item', 'peakshops' ),
				'measurement'               => __( 'Measurement', 'peakshops' ),
				'numeric-slider'            => __( 'Numeric Slider', 'peakshops' ),
				'on-off'                    => __( 'On/Off', 'peakshops' ),
				'page-checkbox'             => __( 'Page Checkbox', 'peakshops' ),
				'page-select'               => __( 'Page Select', 'peakshops' ),
				'post-checkbox'             => __( 'Post Checkbox', 'peakshops' ),
				'post-select'               => __( 'Post Select', 'peakshops' ),
				'radio'                     => __( 'Radio', 'peakshops' ),
				'radio-image'               => __( 'Radio Image', 'peakshops' ),
				'select'                    => __( 'Select', 'peakshops' ),
				'sidebar-select'            => __( 'Sidebar Select', 'peakshops' ),
				'slider'                    => __( 'Slider', 'peakshops' ),
				'social-links'              => __( 'Social Links', 'peakshops' ),
				'spacing'                   => __( 'Spacing', 'peakshops' ),
				'tab'                       => __( 'Tab', 'peakshops' ),
				'tag-checkbox'              => __( 'Tag Checkbox', 'peakshops' ),
				'tag-select'                => __( 'Tag Select', 'peakshops' ),
				'taxonomy-checkbox'         => __( 'Taxonomy Checkbox', 'peakshops' ),
				'taxonomy-select'           => __( 'Taxonomy Select', 'peakshops' ),
				'text'                      => __( 'Text', 'peakshops' ),
				'textarea'                  => __( 'Textarea', 'peakshops' ),
				'textarea-simple'           => __( 'Textarea Simple', 'peakshops' ),
				'textblock'                 => __( 'Textblock', 'peakshops' ),
				'textblock-titled'          => __( 'Textblock Titled', 'peakshops' ),
				'typography'                => __( 'Typography', 'peakshops' ),
				'upload'                    => __( 'Upload', 'peakshops' ),
			)
		);
	...
	function ot_radio_images( $field_id = '' ) {
		...
		return apply_filters(
			...
			array(
				array(
					'value' => 'left-sidebar',
					'label' => __( 'Left Sidebar', 'peakshops' ),
					'src'   => OT_URL . 'assets/images/layout/left-sidebar.png',
				),
				array(
					'value' => 'right-sidebar',
					'label' => __( 'Right Sidebar', 'peakshops' ),
					'src'   => OT_URL . 'assets/images/layout/right-sidebar.png',
				),
				array(
					'value' => 'full-width',
					'label' => __( 'Full Width (no sidebar)', 'peakshops' ),
					'src'   => OT_URL . 'assets/images/layout/full-width.png',
				),
				array(
					'value' => 'dual-sidebar',
					'label' => __( 'Dual Sidebar', 'peakshops' ),
					'src'   => OT_URL . 'assets/images/layout/dual-sidebar.png',
				),
				array(
					'value' => 'left-dual-sidebar',
					'label' => __( 'Left Dual Sidebar', 'peakshops' ),
					'src'   => OT_URL . 'assets/images/layout/left-dual-sidebar.png',
				),
				array(
					'value' => 'right-dual-sidebar',
					'label' => __( 'Right Dual Sidebar', 'peakshops' ),
	...
	function ot_list_item_settings( $id ) {
		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					'id'        => 'description',
					'label'     => __( 'Description', 'peakshops' ),
					'desc'      => '',
					'std'       => '',
	...
	function ot_social_links_settings( $id ) {
		...
		$settings = apply_filters(
			...
			array(
				array(
					'id'    => 'name',
					'label' => __( 'Name', 'peakshops' ),
					'desc'  => __( 'Enter the name of the social website.', 'peakshops' ),
					'std'   => '',
					'type'  => 'text',
				...
				array(
					'id'    => 'title',
					'label' => 'Title',
					'desc'  => __( 'Enter the text shown in the title attribute of the link.', 'peakshops' ),
					'type'  => 'text',
				),
				array(
					'id'    => 'href',
	...
	function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
		...
		if ( file_exists( $filepath ) ) {
			...
			if ( ! is_writable( $filepath ) ) {
				add_settings_error( 'option-tree', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'peakshops' ), '<code>' . $filepath . '</code>' ), 'error' );
				return false;
			}
...
if ( ! function_exists( 'ot_sections_view' ) ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'peakshops' ) . '">
          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'peakshops' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'peakshops' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'peakshops' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'peakshops' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'peakshops' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'peakshops' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'peakshops' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'peakshops' ) . '</option>
              </select>
            </div>
          </div>
        </div>
...
if ( ! function_exists( 'ot_choices_view' ) ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . __( 'Image Source (Radio Image only)', 'peakshops' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'peakshops' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
	...
	function ot_layout_view( $key, $data = '', $active_layout = '' ) {
		...
		return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'peakshops' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'peakshops' ) . '">
          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'peakshops' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'peakshops' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'peakshops' ) . '
        </a>
...
if ( ! function_exists( 'ot_theme_options_layouts_form' ) ) {
	...
	function ot_theme_options_layouts_form( $active = false ) {
		...
		echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'peakshops' ) . '">' . __( 'New Layout', 'peakshops' ) . '</button>';
		...
		array(
			...
			'fields'   => array(
				array(
					...
					'label' => '',
					'desc'  => __( 'Source Name (ex. author, singer, actor)', 'peakshops' ),
					'std'   => '',
					'type'  => 'text',
				),
				array(
				...
				array(
					...
					'label' => '',
					'desc'  => __( 'Source Title (ex. book, song, movie)', 'peakshops' ),
					'std'   => '',
					'type'  => 'text',
				),
				array(
		...
		array(
			...
			'fields'   => array(
				array(
					...
					'label' => '',
					'desc'  => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'peakshops' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'peakshops' ) . '</a>', '<code>[video]</code>' ),
					'std'   => '',
					'type'  => 'textarea',
				),
			),
		...
		array(
			...
			'fields'   => array(
				array(
					...
					'label' => '',
					'desc'  => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'peakshops' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'peakshops' ) . '</a>', '<code>[audio]</code>' ),
					'std'   => '',
					'type'  => 'textarea',
				),
			),
